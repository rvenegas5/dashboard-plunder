      ...
      <Switch>
        ...
        <Route path="/desktop-congratulations-50-off">
          <DesktopCongratulations50Off
            ...
            shopNow="SHOP NOW"
            buttonCloseCopy2Props={desktopCongratulations50OffData.buttonCloseCopy2Props}
          />
        </Route>
        ...
        <Route path="/desktop-my-connections-ecwid-social-connect-dashboard">
          <DesktopMyConnectionsEcwidSocialConn {...desktopMyConnectionsEcwidSocialConnData} />
        </Route>
        <Route path="/desktop-my-account">
          <DesktopMyAccount {...desktopMyAccountData} />
        </Route>
        <Route path="/desktop-my-reports-distributers-only">
          <DesktopMyReportsDISTRIBUTERSONLY {...desktopMyReportsDISTRIBUTERSONLYData} />
        </Route>
        ...
        <Route path="/tablet-congratulations-50-off">
          <TabletCongratulations50Off
            ...
            congratulations="Congratulations!"
            buttonCloseCopy2Props={tabletCongratulations50OffData.buttonCloseCopy2Props}
          />
        </Route>
        ...
        <Route path="/tablet-my-connections-ecwid-social-connect-dashboard">
          <TabletMyConnectionsEcwidSocialConne {...tabletMyConnectionsEcwidSocialConneData} />
        </Route>
        <Route path="/tablet-my-account">
          <TabletMyAccount {...tabletMyAccountData} />
        </Route>
        <Route path="/tablet-my-reports-distributers-only">
          <TabletMyReportsDISTRIBUTERSONLY {...tabletMyReportsDISTRIBUTERSONLYData} />
        </Route>
        ...
        <Route path="/mobile-congratulations-50-off">
          <MobileCongratulations50Off
            ...
            buttonCloseCopy2Props={mobileCongratulations50OffData.buttonCloseCopy2Props}
        ...
        <Route path="/mobile-my-reports-distributers-only">
          <MobileMyReportsDISTRIBUTERSONLY
            ...
            paginationProps={mobileMyReportsDISTRIBUTERSONLYData.paginationProps}
          />
        </Route>
...
const desktopMyAccountData = {
    ...
    levelStatusCusto: <React.Fragment>Level Status Customer Type<br />Sponsor Name: Enroller_First $Enroller_Last<br />Sponsor ID: Sponsor_ID</React.Fragment>,
    phone: "${phone}",
    email: "${email}",
...
const tabletDashboardData = {
    ...
    x12Months: <React.Fragment>12<br />MONTHS</React.Fragment>,
    path644: "/img/path-64-7@1x.png",
    iconGift2: "/img/path-68-3@1x.png",
    x20BonusPoints: <React.Fragment>20<br />bonus points</React.Fragment>,
    x30BonusPoints: <React.Fragment>30<br />bonus points</React.Fragment>,
    x50BonusPoints: <React.Fragment>50<br />bonus points</React.Fragment>,
    x75BonusPointsGifts: <React.Fragment>75<br />bonus points<br />+ gifts</React.Fragment>,
    x9Months: <React.Fragment>9<br />MONTHS</React.Fragment>,
    x6Months: <React.Fragment>6<br />MONTHS</React.Fragment>,
    x3Months: <React.Fragment>3<br />MONTHS</React.Fragment>,
...
const group6833Data = {
    className: "group-67-3",
};

const group6834Data = {
    className: "group-66-3",
};
